...
@Composable
fun AnimatedContainer(fromTopToBottom:Int=0,fromBottomToTop:Int=0,fromRightToLeft:Int=0,delayTime:Int=10,modifier: Modifier=Modifier,content:@Composable ()->Unit) {
